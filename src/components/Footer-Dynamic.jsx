...
const Footer = () => {
    ...
    useEffect(() => {
        const fetchFooterSettings = async () => {
            try {
                const response = await api.get('/Home/FooterSettings');
    ...
    const getDefaultSettings = () => ({
        brand: {
            name: 'پردیس توس',
            description: 'بهترین پلتفرم آموزش آنلاین ایران با بیش از ۱۰۰۰ دوره تخصصی و اساتید مجرب.'
        },
        contact: {
            address: 'تهران، خیابان ولیعصر، پلاک ۱۲۳',
            phone: '021-1234-5678',
            email: 'info@pardistous.ir'
        },
        socialMedia: {
            instagram: null,
            twitter: null,
        ...
        stats: {
            coursesCount: '۱۰۰۰+',
            studentsCount: '۵۰۰۰+',
            instructorsCount: '۱۰۰+'
        },
        newsletter: {
            enabled: true,
            title: 'عضویت در خبرنامه',
            description: 'از آخرین دوره‌ها و تخفیف‌های ویژه باخبر شوید'
        },
        copyright: {
            text: 'آکادمی پردیس توس - تمامی حقوق محفوظ است'
        },
        enamad: {
            url: 'https://trustseal.enamad.ir/?id=5272990&Code=fDfKAiPgvcH664AEtkOpBLvv4wGKnNO9',
            code: 'fDfKAiPgvcH664AEtkOpBLvv4wGKnNO9'
        }
    });

    // استفاده از تنظیمات یا مقادیر پیش‌فرض
    const footerData = settings || getDefaultSettings();
                        ...
                        <div className="lg:col-span-1 space-y-6">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div className="text-center p-3 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10">
                                    <div className="text-2xl font-black text-primary-400">{footerData.stats.coursesCount}</div>
                                    <div className="text-xs text-slate-400">دوره آموزشی</div>
                                </div>
                                <div className="text-center p-3 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10">
                                    <div className="text-2xl font-black text-secondary-400">{footerData.stats.studentsCount}</div>
                                    <div className="text-xs text-slate-400">دانشجو</div>
                                </div>
                                <div className="text-center p-3 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10">
                                    <div className="text-2xl font-black text-secondary-400">{footerData.stats.instructorsCount}</div>
                                ...
                                {footerData.contact.address && (
                                    <div className="flex items-start gap-3 p-3 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-colors duration-300">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-slate-300 text-sm">{footerData.contact.address}</div>
                                        </div>
                                    </div>
                                )}
                                ...
                                {footerData.contact.phone && (
                                    <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-colors duration-300">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-slate-300 text-sm" dir="ltr">{footerData.contact.phone}</div>
                                        </div>
                                    </div>
                                )}
                                ...
                                {footerData.contact.email && (
                                    <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-colors duration-300">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-slate-300 text-sm" dir="ltr">{footerData.contact.email}</div>
                                        </div>
                                    </div>
                                )}
                            </div>
                                ...
                                <div className="flex gap-3">
                                    {footerData.socialMedia.instagram && (
                                        <a
                                            ...
                                            className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:shadow-lg hover:bg-pink-500"
                                        >
                                            <Instagram size={18} />
                                        </a>
                                    )}
                                    {footerData.socialMedia.twitter && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:shadow-lg hover:bg-blue-500"
                                        >
                                            <Twitter size={18} />
                                        </a>
                                    )}
                                    {footerData.socialMedia.linkedin && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:shadow-lg hover:bg-blue-600"
                                        >
                                            <Linkedin size={18} />
                                        </a>
                                    )}
                                    {footerData.socialMedia.youtube && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:shadow-lg hover:bg-red-500"
                                        >
                                            <Youtube size={18} />
                                        </a>
                                    )}
                        ...
                        <div className="container mx-auto px-4 py-8">
                            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                                <div className="text-center md:text-right">
                                    ...
                                    <p className="text-slate-300">{footerData.newsletter.description}</p>
                                </div>
                    ...
                    <div className="container mx-auto px-4 py-6">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                            <div className="text-slate-400 text-sm text-center md:text-right">
                                © {persianYear} {footerData.copyright.text}
                            ...
                            <div className="flex flex-wrap items-center justify-center md:justify-end gap-4">
                                {/* Enamad Trust Seal */}
                                {footerData.enamad.url && footerData.enamad.code && (
                                    <a
                                        referrerPolicy='origin'
                                        target='_blank'
                                        rel='noopener noreferrer'
                                        href={footerData.enamad.url}
                                    ...
                                    >
                                        <div className="relative bg-white rounded-2xl p-4 shadow-2xl hover:shadow-green-500/30 transition-all duration-500 group-hover:scale-110 border-4 border-white group-hover:border-green-400">
                                            <img
                                                referrerPolicy='origin'
                                                src={`https://trustseal.enamad.ir/logo.aspx?id=5272990&Code=${footerData.enamad.code}`}
                                                alt='نماد اعتماد الکترونیک'
                                                className="w-24 h-24 object-contain block"
                                                code={footerData.enamad.code}
                                                style={{
